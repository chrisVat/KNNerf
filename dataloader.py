...
class Spectrum_dataset(Dataset):
    ...
    def __getitem__(self, index):
        inputs = self.nn_inputs[index*self.rays_per_spectrum]
        label = self.nn_labels[index*self.rays_per_spectrum:index*self.rays_per_spectrum+self.rays_per_spectrum]
